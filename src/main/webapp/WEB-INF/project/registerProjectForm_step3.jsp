...
<body>
 <div class="main">
	...
	<div id="enrollProgress">
      ...
      <div class="right">
      	<p></p>
        <button class="goNext" onClick="div_show();">창작자 정보 입력</button>
        <c:if test="${isCre}">
 		...
 		<div id="creatorForm">
	      	<form name="form" method="post" enctype="multipart/form-data" action="<c:url value='/project/register/creator' />">
				...
				<input type="text" name="teamName" value="${creator.nickName}">
				<p>Q2. 창작자(팀) 이미지를 첨부해주세요.</p><c:if test="${isCre}"> 수정을 원하는 경우에만 첨부해주세요.</c:if>
				<input type="file" name="teamImage">
				<p>Q3. 창작자(팀) 소개를 작성해주세요.</p>
				<textarea rows="15" cols="100" name="teamDetail">${creator.creatorInfo}</textarea>
				<p>Q4. 입금 계좌 정보를 입력해주세요.</p>
				<input type="text" name="account" value="${creator.account}">
				<p></p>
